...
KAFKA_CLUSTER_ID="$(/home/amin/tools/confluent-8.3.1/bin/kafka-storage random-uuid)"

/home/amin/tools/confluent-8.3.1/bin/kafka-storage format --standalone -t $KAFKA_CLUSTER_ID -c /home/amin/tools/confluent-8.3.1/etc/kafka/server.properties


/home/amin/tools/confluent-8.3.1/bin/kafka-server-start /home/amin/tools/confluent-8.3.1/etc/kafka/server.properties >  /home/amin/tools/confluent-8.3.1/tmp/broker.log 2>&1 &


/home/amin/tools/confluent-8.3.1/bin/ksql-server-start /home/amin/tools/confluent-8.3.1/etc/ksqldb/ksql-server.properties > /home/amin/tools/confluent-8.3.1/tmp/ksqldb.log 2>&1 &