...
KAFKA_CLUSTER_ID="$(/home/$(whoami)/tools/confluent-8.3.1/bin/kafka-storage random-uuid)"

/home/$(whoami)/tools/confluent-8.3.1/bin/kafka-storage format --standalone -t $KAFKA_CLUSTER_ID -c /home/$(whoami)/tools/confluent-8.3.1/etc/kafka/server.properties


/home/$(whoami)/tools/confluent-8.3.1/bin/kafka-server-start /home/$(whoami)/tools/confluent-8.3.1/etc/kafka/server.properties >  /home/$(whoami)/tools/confluent-8.3.1/tmp/broker.log 2>&1 &


/home/$(whoami)/tools/confluent-8.3.1/bin/ksql-server-start /home/$(whoami)/tools/confluent-8.3.1/etc/ksqldb/ksql-server.properties > /home/$(whoami)/tools/confluent-8.3.1/tmp/ksqldb.log 2>&1 &